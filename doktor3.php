...
<html lang="pl-PL">
    ...
    <body>
        ...
        <div id="main">
            ...
            <div id="prawy2">
                <a href="doktor4.php" id="dod">EDYTUJ DANE PACJENTA</a>
                <br>
                <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                    ...
                    <input type="submit" id="send" name="send" value="dodaj pacjenta">
                </form>
                <a href="doktor.php"><img src="doktor.png" id="dp2"></a>
                <?php
                ...
                if ($_SERVER["REQUEST_METHOD"] == "POST"&&isset($_POST["send"]))
                {
                    ...
                    if(preg_match("(\b\d{11})",$pesel)&&preg_match("(\b\d{9})",$telefon))
                    {
                        ...
                        if($count2==0)
                        {
                            $a="INSERT INTO `pacjenci` (`imie`,`nazwisko`,`pesel`,`adres`,`tel`) VALUES ('".$imie."','".$nazwisko."','".$pesel."','".$adres."','".$telefon."')";
                            echo "<br>";
                        ...
                        {
                            echo "Pacjent o podanym peselu już istnieje w bazie danych";
                        }
                    }
